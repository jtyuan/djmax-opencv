...
#     _logger.debug(associate_v3(dets, preds, dist_threshold=20, logger=_logger))
    ...
    dets = np.array([[177, 700, 270, 724, 0.83162, 2],
 [176, 554, 272, 580, 0.80482, 1],
 [176, 367, 271, 392, 0.88076, 0]])
    preds = np.array(
[[176, 741.19, 271, 768.19, 0.7246, 1, 36, 7.7759e+05, 889.02, 0],
 [177, 732.19, 270, 750.19, 0.71477, 0, 37, 7.7759e+05, 889.02, 1],
 [176, 690.19, 273, 714.19, 0.92213, 2, 38, 7.7759e+05, 889.02, 2],
 [176, 542.19, 272, 570.19, 0.83691, 1, 39, 7.7759e+05, 889.02, 3],
 [176, 358.19, 272, 383.19, 0.89694, 0, 40, 7.7759e+05, 889.02, 4]])
    _logger.debug(associate_v3(dets, preds, dist_threshold=20, logger=_logger))
